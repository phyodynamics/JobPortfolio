...
export const Card = ({
  ...
  return (
    <>
      ...
      >
        <div className="pointer-events-none absolute inset-x-0 bottom-0 z-30 h-2/3 bg-gradient-to-t from-black/70 via-black/30 to-transparent" />
...
export const BlurImage = ({
  ...
  className,
  alt,
  fill, // Destructured to prevent passing to img
  ...rest
}: ImageProps) => {
  return (
    <img
